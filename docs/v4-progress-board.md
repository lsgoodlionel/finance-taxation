...
| V4-1B 采购报销 | `codex/v4-expense-purchase-slice` | `in_progress` | 标准/异常路径生产门禁 |
| V4-2 差旅报销 | `codex/v4-travel-expense-slice` | `in_progress` | 标准/异常路径生产门禁 |
| V4-3 合同收入 | `codex/v4-contract-revenue-slice` | `in_progress` | 合同至申报闭环 |
| V4-4 任务与连接器 | `codex/v4-job-and-connectors` | `in_progress` | 重试、沙箱、文件交换 |
| V4-5 安全与运维 | `codex/v4-security-operations` | `in_progress` | 私有云生产认证 |
