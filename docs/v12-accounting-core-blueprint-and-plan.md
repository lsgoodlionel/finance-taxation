...
| D5 | **F11 多币种最小版本** | 出现真实外币业务客户——**尚未触发，刻意不做**，见下 |
...
蓝图给的触发条件是「出现真实外币业务客户」，目前没有。

多币种的「最小版本」边界完全取决于真实需求形态：汇率来源（央行中间价 / 银行牌价 / 手工录入）、期末调汇范围（货币性项目 vs 全部）、汇兑损益进财务费用还是单列、要不要保留原币金额列——每一项选错都要返工，而这些只有真实客户能回答。没有需求就动手等于猜，猜错的返工成本高于等待成本。
