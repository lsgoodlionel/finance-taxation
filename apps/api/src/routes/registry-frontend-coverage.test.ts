...
const KNOWN_GAPS: ReadonlyMap<string, string> = new Map([
  ...
  ["GET /api/tax/vat-settlement", "增值税期末结转：月度必做，待接入税务中心"],
  ["POST /api/tax/vat-settlement", "同上"],
  ["GET /api/ledger/fiscal-years", "年度结转：年末必做，待接入总账中心"],
  ["POST /api/ledger/fiscal-years/:id/close", "同上"],
