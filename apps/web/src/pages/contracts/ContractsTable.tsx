          ...
          contracts.map((contract) => (
            <tr key={contract.id}>
              <td style={cellStyle()}>
                ...
                <div style={{ color: "#8a9bb0", fontSize: "11px" }}>{contract.contractNo}</div>
              </td>
              <td style={cellStyle()}>{contractTypeLabels[contract.contractType] ?? contract.contractType}</td>
              <td style={cellStyle()}>{contract.counterpartyName}</td>
              <td style={cellStyle()}>
              ...
              <td style={{ ...cellStyle(), textAlign: "center" }}>{contract.relatedEventCount}</td>
              <td style={cellStyle()}>
