  ...
  return (
    <HelpPanel
      ...
      workflowSteps={[
        ...
        <>工资确认：本月工资全部确认，它通常是当月最大的一笔费用</>,
        <>社保关账：生成三险一金的申报与凭证，依赖工资已确认</>,
        <><Term k="accrual">计提</Term><Term k="depreciation">折旧</Term>：给设备等固定资产按月记一笔损耗费用</>,
        <>银行对账：封存余额调节表，把银行余额与账面余额的差额解释清楚</>,
      ...
      responsibility="这里是按月收账的总控页：11 个步骤组成有序的月结状态机，必须按顺序推进——前置步骤未完成时，后续步骤恒为锁定状态，直到全部完成并归档锁账。"
      operations={(
        <>
